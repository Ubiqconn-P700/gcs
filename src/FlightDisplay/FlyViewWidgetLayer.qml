...
Item {
    ...
    FlyViewInstrumentPanel {
        ...
        visible:                    QGroundControl.settingsManager.flyViewSettings.showInstrumentPanel.rawValue && QGroundControl.corePlugin.options.flyView.showInstrumentPanel && multiVehiclePanelSelector.showSingleVehiclePanel
